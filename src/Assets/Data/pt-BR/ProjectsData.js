...
{ 
    Projects:
    {
        "Backend":[
            {
                "id":1,
                "name": "Loja Fullstack Next.js - .NET Core",
                "description": "Criado como parte de um teste técnico para uma vaga de desenvolvedor fullstack. O projeto consiste em uma loja online com listagem de produtos, compras e relatórios de compra. O backend foi desenvolvido em .NET Core e o frontend em Next.js.\n Estou muito satisfeito com o resultado alcançado e com a oportunidade de aprimorar minhas habilidades em desenvolvimento fullstack. Além disso, pude aplicar diferentes técnicas e metodologias para desenvolver sistemas de alta qualidade como DDD, Redux e Clean Code.",
                "image": FullstackNext,
